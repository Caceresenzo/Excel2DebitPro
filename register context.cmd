...
%SystemRoot%\System32\reg.exe ADD "HKEY_CLASSES_ROOT\SystemFileAssociations\.xlsx\shell\excel2debitpro"               /v Icon /t REG_SZ /d "\"%~DP0\ressources\icon.ico\"" /f
...
%SystemRoot%\System32\reg.exe ADD "HKEY_CLASSES_ROOT\SystemFileAssociations\.xlsx\shell\excel2debitprodebug"          /v Icon /t REG_SZ /d "\"%~DP0\ressources\icon.ico\"" /f
